...
#! rendering programming concepts in HTML using some specific formats
...
def success(score):
    ...
    resObject = {"res":res , "score":score}
    # return "The student has passed with score = " + str(score)
    return render_template("result.html", result = res, score = score , completeResult = resObject)
